  ...
  return (
    <>
      <details ref={dropdownRef} className="dropdown dropdown-end leading-3">
        <summary className="btn bg-black border-2 border-gray-700 hover:border-orange-500 btn-md pl-0 pr-3 shadow-md dropdown-toggle gap-0 h-auto! rounded-none">
          <BlockieAvatar address={checkSumAddress} size={36} ensImage={ensAvatar} />
          <span className="ml-2 mr-1 text-base">
            {isENS(displayName) ? displayName : checkSumAddress?.slice(0, 6) + "..." + checkSumAddress?.slice(-4)}
          </span>
          <ChevronDownIcon className="h-6 w-5 ml-2 sm:ml-0" />
        </summary>
